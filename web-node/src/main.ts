...
import { ScrcpyClient } from '@yume-chan/adb-scrcpy';
import { AdbWebSocketTransport } from '@yume-chan/adb-transport-websocket';
...
let transport: AdbWebSocketTransport | undefined;
let adb: Adb | undefined;
let scrcpyClient: ScrcpyClient | undefined;
